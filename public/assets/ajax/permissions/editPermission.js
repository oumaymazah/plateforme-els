document.addEventListener("click", function (event) {
    if (event.target.matches("#open-edit-permission-modal")) {
                ...
                form.addEventListener('submit', function (event) {
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            document.getElementById("load-permission").click(); // Recharger la liste des permissions
                        } else if (data.errors) {
                    ...
                    .catch(error => {
                        ...
                        showErrorAlert('Une erreur est survenue lors de la modification de la permission.');
                    });
                });
            })
