...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/image-cropper.css')); ?>">
<?php $__env->stopPush(); ?>
				...
				<div class="card-body">
				  <div class="row">
					<div class="col-xl-9 col-md-12">
					  <div class="img-container"><img id="image" src="<?php echo e(asset('assets/images/other-images/img-cropper.jpg')); ?>" alt="Picture"></div>
					</div>
			  ...
			  <div class="row">
				<div class="col-md-6">
				  <div class="card">
					...
					<div class="card-body">
					  <div class="img-container"><img class="crop-zoomable img-fluid" src="<?php echo e(asset('assets/images/other-images/img-cropper.jpg')); ?>" alt=""></div>
					</div>
				  </div>
				</div>
				<div class="col-md-6">
				  <div class="card">
					...
					<div class="card-body">
					  <div class="img-container"><img class="crop-auto img-fluid" src="<?php echo e(asset('assets/images/other-images/img-cropper.jpg')); ?>" alt=""></div>
					</div>
				  </div>
				</div>
				<div class="col-md-6">
				  <div class="card">
					...
					<div class="card-body">
					  <div class="img-container"><img class="crop-drag img-fluid" src="<?php echo e(asset('assets/images/other-images/img-cropper.jpg')); ?>" alt=""></div>
					</div>
				  </div>
				</div>
				<div class="col-md-6">
				  <div class="card">
					...
					<div class="card-body">
					  <div class="img-container"><img class="crop-min img-fluid" src="<?php echo e(asset('assets/images/other-images/img-cropper.jpg')); ?>" alt=""></div>
					</div>
				  </div>
				</div>
			  </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\apprendre laravel\platformeEls\resources\views/admin/bonus-ui/image-cropper.blade.php ENDPATH**/ ?>