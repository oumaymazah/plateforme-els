        ...
        $(document).ready(function(){
            ...
            function updateStars(rating) {
                $('.star-container').each(function() {
                    ...
                    starIcon.removeClass('fa-star fa-star-half-o').addClass('fa-star-o');
                    if (rating >= value) {
                        starIcon.removeClass('fa-star-o fa-star-half-o').addClass('fa-star');
                    } else if (rating + 0.5 >= value && rating < value) {
                        starIcon.removeClass('fa-star-o fa-star').addClass('fa-star-half-o');
                    }
                });
            }
            ...
            $('form').on('submit', function(event) {
                if (!$('#formation_id').val()) {
                    $('#formation_id').addClass('is-invalid');
