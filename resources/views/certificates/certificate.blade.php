    ...
    <div class="certificate-container">
        <div class="certificate-inner">
            ...
            <div class="certificate-body">
                ...
                <h2 class="certificate-user">{{ $user->name }}</h2>
                <p class="certificate-text">pour avoir complété avec succès la formation</p>
                <h3 class="certificate-course">{{ $training->title }}</h3>

                <div class="certificate-details">
                    <div class="detail-item">
                        <div class="detail-label">Date d'obtention</div>
                        <div class="detail-value">{{ $certification->obtained_date->format('d/m/Y') }}</div>
                    </div>
                    <div class="detail-item">
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-value">{{ $training->duration }} heures</div>
                    </div>
                </div>
            ...
            <div class="certificate-footer">
                ...
                <div class="certificate-number">
                    N° {{ $certification->certificate_number }}
                </div>
            </div>
